...
const Registration = () => {
    ...
    return (
        <div className='min-h-screen py-10 bg-black bg-blend-overlay bg-opacity-80' style={{ backgroundImage: 'url("https://img.freepik.com/premium-vector/register-now-label-with-megaphone-badge-registration_349999-1466.jpg?w=1060")', backgroundSize: 'cover' }}>
            <section className="dark:bg-gray-900">
                <div className="flex flex-col lg:gap-20 lg:flex-row items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                    <div className="w-full shadow-xl rounded-lg dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={handleRegi} className="space-y-4 md:space-y-6" action="#">
                                <div>
                                    <label className="block mb-2 font-medium text-white dark:text-white">User Name</label>
                                    <input type="text" name="username" className="bg-gray-50 border border-gray-300 text-white sm:text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John Doe" required="" />
                                </div>
                                <div>
                                    <label className="block mb-2 font-medium text-white dark:text-white">Image URL</label>
                                    <input type="text" name="imageURL" className="bg-gray-50 border border-gray-300 text-white sm:text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="http//:exp.com" required="" />
                                </div>
                                <div>
                                    <label className="block mb-2 font-medium text-white dark:text-white">Your email</label>
                                    <input type="email" name="email" className="bg-gray-50 border border-gray-300 text-white sm:text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required="" />
                                </div>
                                <div>
 ...
 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                                ...
                                <p className="font-light text-white dark:text-gray-400">
                                    Already have an account? <a href="#" className="font-medium text-yellow-600 hover:underline dark:text-primary-500"><Link to='/login'>Login here</Link></a>
                                </p>
                            </form>
                        </div>
                    </div>
