...
const Registration = () => {
    ...
    return (
        <div className='min-h-screen py-32 bg-black bg-blend-overlay bg-opacity-80' style={{ backgroundImage: 'url("https://img.freepik.com/premium-vector/register-now-label-with-megaphone-badge-registration_349999-1466.jpg?w=1060")', backgroundSize: 'cover' }}>
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={handleRegi} className="space-y-4 md:space-y-6" action="#">
                                <div>
                                    ...
                                    <input type="text" name="username" className="bg-gray-50 border border-gray-300 text-black sm:text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="John Doe" required="" />
                                </div>
                                <div>
                                    <label className="block mb-2 font-medium text-white dark:text-white">Image URL</label>
                                    <input type="text" name="imageURL" className="bg-gray-50 border border-gray-300 text-black sm:text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="http//:exp.com" required="" />
                                </div>
                                <div>
                                    <label className="block mb-2 font-medium text-white dark:text-white">Your email</label>
                                    <input type="email" name="email" className="bg-gray-50 border border-gray-300 text-black sm:text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@company.com" required="" />
                                </div>
                                <div>
