        ...
        <div>
            <footer className="bg-[#001D4F]">
                <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
                    ...
                    <p className="mx-auto mt-2 max-w-xl text-center leading-relaxed text-white">
                        We’ve been building Todoist for 16 years and 325 days. Rest assured that we’ll never sell out to the highest bidder.
                    </p>
                    <div class="mx-auto max-w-md mt-5">
                        <h1 className='text-white text-base text-center'>Want us to email you with the latest blockbuster news?</h1>
                        ...
                        <form class="mt-2">
                            <div class="relative max-w-lg">
                                ...
                                <button
                                    class="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-red-500 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700"
                                >
                                    Subscribe
                                </button>
                            </div>
                    ...
                    <ul className="mt-4 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
                        <li>
                            <Link className="text-white transition hover:text-red-500/75" href="/"> About </Link>
                        </li>

                        <li>
                            <Link className="text-white transition hover:text-red-500/75" href="/"> Careers </Link>
                        </li>

                        <li>
                            <Link className="text-white transition hover:text-red-500/75" href="/"> History </Link>
                        </li>

                        <li>
                            <Link className="text-white transition hover:text-red-500/75" href="/"> Services </Link>
                        </li>

                        <li>
                            <Link className="text-white transition hover:text-red-500/75" href="/"> Projects </Link>
                        </li>

                        <li>
                            <Link className="text-white transition hover:text-red-500/75" href="/"> Blog </Link>
                        </li>
                    </ul>
                    ...
                    <ul className="mt-4 flex justify-center gap-6 md:gap-8">
                        <li>
                            <Link
                                ...
                                rel="noreferrer"
                                target="_blank"
                                className="text-white transition hover:text-red-500/75"
                            >
                        ...
                        <li>
                            <Link
                                to={`https://github.com/Shimul-Zahan`}
                                rel="noreferrer"
                                target="_blank"
                                className="text-white transition hover:text-red-500/75"
                            >
